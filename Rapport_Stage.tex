...
Cette partie retrace mes activités dans l'entreprise de fin Avril jusqu'au début du mois de juin. L'essentiel du travail effectué était consacré à la modélisation de l'outil et au chiffrage des phases de développement du projet.  
...
À l'issue des réflexions, nous avons pu aboutir à plusieurs diagrammes: l'un représentant les entités à récupérer avec les liens entre eux, et les autres représentent des diagrammes d'activités qui correspondent à l'alimentation de notre base de données.
