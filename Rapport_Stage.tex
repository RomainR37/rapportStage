...
%TODO A CHANGER depuis la version 11, c'est ok, les banques ont les mêmes modules
...
%TODO Pattern MVVM au lieu de MVC, voir https://www.dotnetdojo.com/mvvm/

Le projet est séparé en deux parties avec le \textit{back-end} d'un côté et le \textit{front-end} de l'autre. L'idée est de respecter un pattern MVV, ainsi la partie \textit{back-end} contiendra les éléments du Modèle et du Contrôleur et la partie \textit{front-end} s'occupera des Vues. La \autoref{fig:arboBackEnd} représente l'arborescence du \textit{back-end} de l'application.
...
%TODO voir l'aspect package MAVEN, installation d'Angular-cli, de npm, de ng, etc.
